        ...
        <div className="w-full max-w-full lg:max-w-[1200px] xl:max-w-[1440px] mx-auto px-4 md:px-6 lg:px-8 xl:px-12 mb-16">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
            {CUSTOM_SOFTWARE_PROJECTS.map((project, index) => (
              ...
              >
                ...
                <div className="relative aspect-[16/10] overflow-hidden bg-surface border-b border-border/50">
                  ...
                  {/* Metric badge */}
                  <div className="absolute top-3 right-3 bg-bg/85 backdrop-blur-md px-2 py-0.5 rounded border border-border text-[9px] font-mono text-accent-custom font-bold uppercase tracking-wider shadow-sm">
                    {project.metric}
                  </div>
                </div>
            ...
            <motion.div
              ...
              className="relative group bg-bg-elevated/40 border border-dashed border-border/80 rounded-2xl p-6 sm:p-8 flex flex-col justify-between items-center text-center shadow-sm hover:border-accent-custom/40 hover:shadow-md transition-all duration-300 min-h-[350px]"
            >
